...
# ---------------------------------------------------------------- Navigation (blog, recrutement)
add({
"Blog": ("Blog", "博客"),
"Recrutement": ("Careers", "招贤纳士"),
"Histoire, équipe, valeurs": ("History, team, values", "历史、团队、价值观"),
"Métiers et candidatures": ("Roles and applications", "岗位与应聘"),
"Découvrir le recrutement": ("See our careers page", "查看招聘信息"),
"Version Markdown": ("Markdown version", "Markdown 版本"),
"Blog SA LA GARONNE": ("SA LA GARONNE blog", "SA LA GARONNE 博客"),
})

# ---------------------------------------------------------------- Page Recrutement
add({
"Recrutement — rejoindre SA LA GARONNE à Toulouse": ("Careers — join SA LA GARONNE in Toulouse", "招贤纳士 — 加入图卢兹 SA LA GARONNE"),
"SA LA GARONNE recrute canalisateurs, chefs de chantier, conducteurs d'engins et opérateurs de réhabilitation à Toulouse. Entreprise familiale, sécurité, formation, candidature spontanée bienvenue.":
  ("SA LA GARONNE is hiring pipelayers, site managers, plant operators and rehabilitation technicians in Toulouse. Family business, safety, training; speculative applications welcome.",
   "SA LA GARONNE 在图卢兹招聘管道工、工地负责人、机械操作手与修复作业技师。家族企业，注重安全与培训，欢迎自荐。"),
"Canalisateurs, chefs de chantier, conducteurs d'engins, opérateurs de réhabilitation : SA LA GARONNE recrute des femmes et des hommes de terrain, débutants comme expérimentés, pour construire et entretenir les réseaux d'eau de Toulouse.":
  ("Pipelayers, site managers, plant operators, rehabilitation technicians: SA LA GARONNE recruits field professionals, entry-level and experienced, to build and maintain the water networks of Toulouse.",
   "管道工、工地负责人、机械操作手、修复作业技师：SA LA GARONNE 招募一线人才，无论新手或资深，共同建设与维护图卢兹的给排水管网。"),
"Équipes": ("Crews", "施工班组"),
"Postes": ("Positions", "工作地点"),
"Basés à Toulouse": ("Based in Toulouse", "图卢兹"),
"Spontanée bienvenue": ("Speculative welcome", "欢迎自荐"),
"Pourquoi nous rejoindre": ("Why join us", "为什么加入我们"),
"Une entreprise à taille humaine, des chantiers qui ne se ressemblent pas.": ("A human-sized company, and no two worksites alike.", "规模适中的企业，各不相同的工程。"),
"Chez SA LA GARONNE, on ne travaille pas sur des chantiers anonymes. Chaque semaine, nos équipes interviennent sur des réseaux que la ville utilise tous les jours, souvent dans des conditions que peu d'entreprises acceptent : hypercentre, grande profondeur, réseaux en service.":
  ("At SA LA GARONNE, no worksite is anonymous. Every week our crews work on networks the city relies on daily, often in conditions few companies take on: city centre, deep excavation, live networks.",
   "在 SA LA GARONNE，没有默默无闻的工程。每周，我们的班组都在城市每天依赖的管网上作业，往往面对少有企业愿意承接的条件：核心城区、深基坑、在役管网。"),
"Nous sommes 35, répartis en quatre équipes de chantier, un atelier et un bureau d'études. Trois générations de la même famille se sont succédé à la tête de l'entreprise depuis 1956 : on se connaît, on se parle, et les décisions se prennent vite.":
  ("We are 35 people, split across four site crews, a workshop and a design office. Three generations of the same family have led the company since 1956: we know each other, we talk, and decisions are made quickly.",
   "我们共 35 人，分布于四支施工班组、一个机修车间和一个技术设计部。自 1956 年起，同一家族三代人先后执掌公司：彼此熟识，沟通顺畅，决策迅速。"),
"Nous recrutons régulièrement, pour renforcer nos équipes et pour transmettre un savoir-faire qui ne s'apprend qu'en le pratiquant.":
  ("We recruit regularly, to strengthen our crews and to pass on know-how that can only be learned by doing.",
   "我们长期招聘，以充实团队，并传承只有通过实践才能习得的技艺。"),
"Ce que nous offrons": ("What we offer", "我们提供"),
"Six bonnes raisons de nous rejoindre.": ("Six good reasons to join us.", "加入我们的六个理由。"),
"Un cadre de travail stable, des méthodes modernes et une sécurité qui ne se négocie pas.": ("A stable workplace, modern methods and safety that is never negotiable.", "稳定的工作环境、现代的施工方法，以及没有商量余地的安全标准。"),
"Un métier qui a du sens": ("A job with meaning", "有意义的工作"),
"L'eau potable qui arrive, les eaux usées qui repartent : nos chantiers servent tout le monde, tous les jours.": ("Drinking water in, wastewater out: our worksites serve everyone, every day.", "让饮用水送达、污水排走：我们的工程每天服务所有人。"),
"Une entreprise familiale": ("A family business", "家族企业"),
"35 collaborateurs, une direction accessible, des équipes stables où chacun est connu par son prénom.": ("35 employees, an approachable management, stable crews where everyone is known by their first name.", "35 名员工，平易近人的管理层，稳定的团队，人人相识。"),
"La sécurité d'abord": ("Safety first", "安全第一"),
"Une responsable QHSE dédiée, des formations AIPR, CATEC, SST et H0B0, des équipements fournis et contrôlés.": ("A dedicated QHSE manager, AIPR, CATEC, first aid and H0B0 training, equipment supplied and checked.", "专职 QHSE 负责人，AIPR、CATEC、急救员及 H0B0 培训，配发并定期查验的防护装备。"),
"Des méthodes modernes": ("Modern methods", "现代工艺"),
"Réhabilitation sans tranchée, fraisage robotisé, robot d'inspection RIC conçu en interne : vous apprenez des techniques d'avenir.": ("Trenchless rehabilitation, robotic milling, the in-house RIC inspection robot: you learn the techniques of tomorrow.", "非开挖修复、机器人铣削、自主研发的 RIC 检测机器人：在这里学习面向未来的技术。"),
"Transmettre et progresser": ("Passing on skills, moving up", "传承与成长"),
"Compagnonnage entre générations de canalisateurs et de chefs de chantier, formations régulières, évolution interne.": ("Mentoring between generations of pipelayers and site managers, regular training, internal progression.", "几代管道工与工地负责人之间的传帮带，定期培训，内部晋升。"),
"Des engagements concrets": ("Concrete commitments", "切实的承诺"),
"Démarche RSE labellisée, paniers de fruits et légumes locaux offerts chaque mois, comité RSE ouvert aux salariés.": ("A labelled CSR programme, local fruit and vegetable baskets offered every month, a CSR committee open to employees.", "获认证的社会责任体系，每月赠送本地果蔬篮，向员工开放的社会责任委员会。"),
"Les métiers": ("The roles", "招聘岗位"),
"Les profils que nous recrutons.": ("The profiles we recruit.", "我们招募的人才。"),
"Des postes de terrain et de bureau d'études, en CDI, en alternance ou en stage selon les besoins de l'année.": ("Field and design office positions, permanent, apprenticeship or internship depending on the year's needs.", "一线岗位与技术设计部岗位，视年度需求提供长期合同、学徒或实习。"),
"Poste": ("Role", "岗位"),
"Profil": ("Profile", "要求"),
"Canalisateur / canalisatrice": ("Pipelayer", "管道工"),
"Pose de canalisations d'assainissement et d'eau potable, branchements, regards, réfection. Le cœur de notre métier, en équipe, sur le terrain.": ("Laying sewer and drinking water pipes, service connections, manholes, reinstatement. The heart of our trade, as a crew, on site.", "敷设排水与饮用水管道、接户管、检查井、路面恢复。这是我们业务的核心，在现场，以团队协作完成。"),
"Débutant motivé ou expérimenté ; permis B apprécié.": ("Motivated beginner or experienced; driving licence appreciated.", "有干劲的新手或有经验者均可；持有驾照者优先。"),
"Chef / cheffe de chantier": ("Site manager", "工地负责人"),
"Organisation du chantier, sécurité, phasage, relation avec le maître d'ouvrage et les riverains, suivi des équipes.": ("Site organisation, safety, phasing, liaison with the client and residents, crew supervision.", "组织施工、安全管理、分期安排、对接业主与周边居民、带领班组。"),
"Expérience en canalisation ou travaux publics, sens de l'organisation.": ("Experience in pipelaying or civil engineering, organisational skills.", "具备管道或市政工程经验，善于组织协调。"),
"Conducteur / conductrice d'engins": ("Plant operator", "机械操作手"),
"Terrassement, levage, pose en tranchée blindée, y compris à grande profondeur et en centre-ville.": ("Earthworks, lifting, laying in shored trenches, including deep excavations and city-centre sites.", "土方开挖、吊装、支护沟槽内敷设，包括深基坑与市中心工地。"),
"CACES à jour, expérience en milieu urbain appréciée.": ("Valid plant licence, urban experience appreciated.", "持有效机械操作证，有城区施工经验者优先。"),
"Opérateur / opératrice de réhabilitation sans tranchée": ("Trenchless rehabilitation technician", "非开挖修复作业技师"),
"Chemisage, fraisage robotisé, inspection télévisée, pilotage des unités mobiles.": ("CIPP lining, robotic milling, CCTV inspection, operating the mobile units.", "原位固化内衬、机器人铣削、闭路电视检测、操作移动作业车。"),
"Formation assurée en interne ; goût pour la technique et la précision.": ("Training provided in-house; a taste for technology and precision.", "公司提供内部培训；热爱技术，注重精确。"),
"Bureau d'études : géomètre-dessinateur, chargé d'études": ("Design office: surveyor-draughtsman, design engineer", "技术设计部：测量绘图员、技术工程师"),
"Levés, plans d'exécution et de récolement, études de prix, appui aux équipes de chantier.": ("Surveys, construction and as-built drawings, cost studies, support for the site crews.", "测量、施工图与竣工图、报价测算、支持施工班组。"),
"Formation topographie ou génie civil, maîtrise des outils de dessin.": ("Surveying or civil engineering background, command of drafting tools.", "测绘或土木工程专业背景，熟练使用绘图软件。"),
"Alternance et stages": ("Apprenticeships and internships", "学徒与实习"),
"Nous accueillons des alternants et des stagiaires sur le terrain comme au bureau d'études.": ("We welcome apprentices and interns on site and in the design office.", "我们欢迎学徒与实习生加入现场或技术设计部。"),
"Bac pro, BTS, licence ou école : parlez-nous de votre projet.": ("Vocational, technical or engineering studies: tell us about your plans.", "职业、技术或工程院校在读：欢迎与我们分享您的规划。"),
"Le parcours": ("The process", "应聘流程"),
"Comment ça se passe.": ("How it works.", "流程说明。"),
"Quatre étapes simples, une réponse à chaque candidature.": ("Four simple steps, and a reply to every application.", "四个简单步骤，每份申请都会得到回复。"),
"Envoyez votre CV et quelques lignes sur votre parcours, par le formulaire ou par email. Nous répondons à toutes les candidatures.": ("Send your CV and a few lines about your background, via the form or by email. We reply to every application.", "通过表单或电子邮件发送您的简历及简要经历。我们会回复每一份申请。"),
"Échange téléphonique": ("Phone call", "电话沟通"),
"Un premier échange pour comprendre votre expérience, vos attentes et vous présenter le poste.": ("A first conversation to understand your experience and expectations, and to present the role.", "初步沟通，了解您的经验与期望，并介绍岗位情况。"),
"Rencontre au siège": ("Meeting at head office", "总部面谈"),
"Un entretien à Toulouse, avec visite de l'atelier et, quand c'est possible, d'un chantier en cours.": ("An interview in Toulouse, with a tour of the workshop and, when possible, of a live worksite.", "在图卢兹进行面谈，参观机修车间，条件允许时参观在建工地。"),
"Intégration": ("Onboarding", "入职融入"),
"Accueil sécurité, équipements fournis, binôme avec un collègue expérimenté pendant les premières semaines.": ("Safety induction, equipment provided, paired with an experienced colleague for the first weeks.", "安全入职培训，配发装备，最初几周由资深同事结对带教。"),
"Envoyez-nous votre candidature.": ("Send us your application.", "向我们投递申请。"),
"Par le formulaire ci-contre ou directement par email, avec votre CV. Candidatures spontanées bienvenues, toute l'année.": ("Using the form or directly by email, with your CV. Speculative applications are welcome all year round.", "通过表单或直接发送电子邮件并附上简历。全年欢迎自荐。"),
"Poste souhaité *": ("Desired role *", "意向岗位 *"),
"Canalisateur": ("Pipelayer", "管道工"),
"Chef de chantier": ("Site manager", "工地负责人"),
"Conducteur d'engins": ("Plant operator", "机械操作手"),
"Alternance / stage": ("Apprenticeship / internship", "学徒 / 实习"),
"Candidature : canalisateur": ("Application: pipelayer", "应聘：管道工"),
"Candidature : chef de chantier": ("Application: site manager", "应聘：工地负责人"),
"Candidature : conducteur d'engins": ("Application: plant operator", "应聘：机械操作手"),
"Candidature : réhabilitation sans tranchée": ("Application: trenchless rehabilitation", "应聘：非开挖修复"),
"Candidature : bureau d'études": ("Application: design office", "应聘：技术设计部"),
"Candidature : alternance / stage": ("Application: apprenticeship / internship", "应聘：学徒 / 实习"),
"Votre parcours *": ("Your background *", "您的经历 *"),
"Votre expérience, vos formations, vos disponibilités…": ("Your experience, training, availability…", "您的工作经验、培训经历、可到岗时间……"),
"J'accepte que les informations saisies soient utilisées pour traiter ma candidature. Elles ne sont ni cédées ni utilisées à d'autres fins.": ("I agree that the information provided may be used to process my application. It is neither shared nor used for any other purpose.", "我同意所填写的信息仅用于处理本次应聘。这些信息不会被转让，也不会用于其他用途。"),
"Envoyer ma candidature": ("Send my application", "提交申请"),
"* Champs obligatoires. Pensez à joindre votre CV par email.": ("* Required fields. Remember to send your CV by email.", "* 为必填项。请记得通过电子邮件发送简历。"),
})
