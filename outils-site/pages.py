...
page("assainissement.html", "Assainissement à Toulouse — SA LA GARONNE",
     "Construction, renouvellement et réhabilitation de réseaux d'assainissement à Toulouse : collecteurs, branchements, réseaux en service, grande profondeur.", body, "chantier-hydrocurage-equipe-1280.jpg",
     crumbs=[("Expertises", "assainissement.html"), ("Assainissement", None)], service="Assainissement")
...
page("eau-potable.html", "Adduction d'eau potable à Toulouse — SA LA GARONNE",
     "Pose et renouvellement de conduites d'eau potable, branchements et ouvrages hydrauliques à Toulouse, avec coupures limitées. SA LA GARONNE, depuis 1956.", body, "chantier-tranchee-centre-ville-1280.jpg",
     crumbs=[("Expertises", "assainissement.html"), ("Adduction d'eau potable", None)], service="Adduction d'eau potable")
...
page("rehabilitation-sans-tranchee.html", "Réhabilitation sans tranchée à Toulouse — SA LA GARONNE",
     "Chemisage, gainage, fraisage robotisé et inspection par robot RIC : rénover les canalisations sans ouvrir la voirie. SA LA GARONNE, Toulouse.", body, "chantier-capitole-engins-1280.jpg",
     crumbs=[("Expertises", "assainissement.html"), ("Réhabilitation sans tranchée", None)], service="Réhabilitation sans tranchée")
...
page("travaux-complexes.html", "Travaux de réseaux complexes à Toulouse — SA LA GARONNE",
     "Réseaux en service, tranchées jusqu'à 7 m, canalisations Ø 2000 mm, hypercentre : des chantiers contraints maîtrisés par SA LA GARONNE à Toulouse.", body, "chantier-capitole-engins-1280.jpg",
     crumbs=[("Expertises", "assainissement.html"), ("Travaux complexes", None)], service="Travaux et interventions complexes sur réseaux")
...
<div class="labels labels--light" data-reveal><div><p class="eyebrow">Qualifications & labels</p><p class="muted" style="margin-top:12px;font-size:.9rem;max-width:28ch">Identifications professionnelles FNTP, labels métier et engagements certifiés.</p></div><div class="labels__list"><span><b>FNTP</b> 5118 · AEP zone urbaine</span><span><b>FNTP</b> 5141 · Tranchées fortes profondeurs</span><span><b>FNTP</b> 5161 · Grand diamètre</span><span><b>FNTP</b> 5221 · Réhabilitation réseaux visitables</span><span>Label Canalisateur</span><span>Label RSE TP</span><span>Engagé RSE · AFNOR</span><span>Amiante SS3</span><span>AIPR · CATEC · SST · H0B0</span><span>Qualibat</span><span>NF · AFNOR</span></div><div class="labels__logos"><img src="assets/labels/fntp.png" alt="Fédération Nationale des Travaux Publics" loading="lazy" width="400" height="341"><img src="assets/labels/label-canalisateur.png" alt="Label Canalisateur — assainissement" loading="lazy" width="193" height="204"><img src="assets/labels/engage-rse-afnor.png" alt="Label Engagé RSE — AFNOR Certification" loading="lazy" width="350" height="346"></div></div></div></section>'''
body += f'''<section class="section bg-navy"><div class="container">{section_head("Valeurs", "Ce qui guide nos équipes.", "Six principes, hérités de 70 ans de terrain, appliqués à chaque intervention.", light=True)}<div class="values values--3 stagger">
...
body += f'''<section class="section section--tight bg-white"><div class="container"><div class="grid grid-5-7"><div><p class="eyebrow" data-reveal>Nous rejoindre</p><h2 class="h2" style="margin-top:20px" data-split>Un métier utile, des chantiers qui comptent.</h2><p class="lead" style="margin-top:24px" data-reveal>Canalisateur, chef de chantier, conducteur d'engins, opérateur de réhabilitation : nous recrutons régulièrement des profils de terrain, débutants comme expérimentés.</p><a class="btn" href="recrutement.html" style="margin-top:32px" data-reveal>Découvrir le recrutement {ARROW}</a></div><div data-reveal><p class="mono" style="color:var(--steel);margin-bottom:12px">Fiche d'identité</p><div class="id-card"><div class="spec"><span class="mono">Dénomination</span><b>SA LA GARONNE</b></div><div class="spec"><span class="mono">Forme juridique</span><b>SA à conseil d'administration</b></div><div class="spec"><span class="mono">Capital social</span><b>400 000 €</b></div><div class="spec"><span class="mono">Création</span><b>1956</b></div><div class="spec"><span class="mono">Direction</span><b>Nicolas Pascual — 3<sup>e</sup> génération</b></div><div class="spec"><span class="mono">Effectif</span><b>35 salariés · 4 équipes de chantier · atelier · bureau d'études</b></div><div class="spec"><span class="mono">Activité</span><b>Assainissement 75 % · eau potable 15 % · sans tranchée 10 %</b></div><div class="spec"><span class="mono">SIREN</span><b>560 800 583</b></div><div class="spec"><span class="mono">Code APE</span><b>4221Z — Construction de réseaux pour fluides</b></div><div class="spec"><span class="mono">Siège</span><b>63 chemin de Guilhermy, 31100 Toulouse</b></div></div></div></div></div></section>'''
body += CTA
page("entreprise.html", "L'entreprise — SA LA GARONNE, Toulouse depuis 1956",
     "Trois générations Pascual, 35 collaborateurs, bureau d'études intégré et robot d'inspection breveté : l'histoire et les valeurs de SA LA GARONNE.", body, "equipe-reunion-inspection-1280.jpg",
...
# ---------------------------------------------------------------- RECRUTEMENT
def job(ico, title, text, profil):
    return f'<div class="service"><span class="mono">Poste</span>{picto(ico)}<div><strong>{title}</strong><p style="margin-top:8px">{text}</p></div><div class="job__profile"><b>Profil</b>{profil}</div></div>'
body = hero(
    ["Recrutement"],
    "Recrutement",
    "Un métier utile, des chantiers qui comptent.",
    "Canalisateurs, chefs de chantier, conducteurs d'engins, opérateurs de réhabilitation : SA LA GARONNE recrute des femmes et des hommes de terrain, débutants comme expérimentés, pour construire et entretenir les réseaux d'eau de Toulouse.",
    [("Effectif", "35 collaborateurs"), ("Équipes", "4 équipes de chantier"), ("Postes", "Basés à Toulouse"), ("Candidature", "Spontanée bienvenue")],
    bg="chantier-tranchee-centre-ville", bgalt="Canalisateur SA LA GARONNE réglant le lit de pose d'une tranchée en centre-ville de Toulouse, pelle mécanique en arrière-plan"
)
body += intro("Pourquoi nous rejoindre", "Une entreprise à taille humaine, des chantiers qui ne se ressemblent pas.",
    ["Chez SA LA GARONNE, on ne travaille pas sur des chantiers anonymes. Chaque semaine, nos équipes interviennent sur des réseaux que la ville utilise tous les jours, souvent dans des conditions que peu d'entreprises acceptent : hypercentre, grande profondeur, réseaux en service.",
     "Nous sommes 35, répartis en quatre équipes de chantier, un atelier et un bureau d'études. Trois générations de la même famille se sont succédé à la tête de l'entreprise depuis 1956 : on se connaît, on se parle, et les décisions se prennent vite.",
     "Nous recrutons régulièrement, pour renforcer nos équipes et pour transmettre un savoir-faire qui ne s'apprend qu'en le pratiquant."])
body += f'''<section class="section bg-navy"><div class="container">{section_head("Ce que nous offrons", "Six bonnes raisons de nous rejoindre.", "Un cadre de travail stable, des méthodes modernes et une sécurité qui ne se négocie pas.", light=True)}<div class="values values--3 stagger">
<div class="value"><span class="exp-card__num">01</span>{picto("eau")}<strong>Un métier qui a du sens</strong><p>L'eau potable qui arrive, les eaux usées qui repartent : nos chantiers servent tout le monde, tous les jours.</p></div>
<div class="value"><span class="exp-card__num">02</span>{picto("equipe")}<strong>Une entreprise familiale</strong><p>35 collaborateurs, une direction accessible, des équipes stables où chacun est connu par son prénom.</p></div>
<div class="value"><span class="exp-card__num">03</span>{picto("securite")}<strong>La sécurité d'abord</strong><p>Une responsable QHSE dédiée, des formations AIPR, CATEC, SST et H0B0, des équipements fournis et contrôlés.</p></div>
<div class="value"><span class="exp-card__num">04</span>{picto("chemisage")}<strong>Des méthodes modernes</strong><p>Réhabilitation sans tranchée, fraisage robotisé, robot d'inspection RIC conçu en interne : vous apprenez des techniques d'avenir.</p></div>
<div class="value"><span class="exp-card__num">05</span>{picto("continuite")}<strong>Transmettre et progresser</strong><p>Compagnonnage entre générations de canalisateurs et de chefs de chantier, formations régulières, évolution interne.</p></div>
<div class="value"><span class="exp-card__num">06</span>{picto("durabilite")}<strong>Des engagements concrets</strong><p>Démarche RSE labellisée, paniers de fruits et légumes locaux offerts chaque mois, comité RSE ouvert aux salariés.</p></div>
</div></div></section>'''
body += f'''<section class="section section--tight bg-white"><div class="container">{section_head("Les métiers", "Les profils que nous recrutons.", "Des postes de terrain et de bureau d'études, en CDI, en alternance ou en stage selon les besoins de l'année.")}<div class="services stagger">
{job("assainissement", "Canalisateur / canalisatrice", "Pose de canalisations d'assainissement et d'eau potable, branchements, regards, réfection. Le cœur de notre métier, en équipe, sur le terrain.", "Débutant motivé ou expérimenté ; permis B apprécié.")}
{job("phasage", "Chef / cheffe de chantier", "Organisation du chantier, sécurité, phasage, relation avec le maître d'ouvrage et les riverains, suivi des équipes.", "Expérience en canalisation ou travaux publics, sens de l'organisation.")}
{job("chantier", "Conducteur / conductrice d'engins", "Terrassement, levage, pose en tranchée blindée, y compris à grande profondeur et en centre-ville.", "CACES à jour, expérience en milieu urbain appréciée.")}
{job("sans-tranchee", "Opérateur / opératrice de réhabilitation sans tranchée", "Chemisage, fraisage robotisé, inspection télévisée, pilotage des unités mobiles.", "Formation assurée en interne ; goût pour la technique et la précision.")}
{job("reseau", "Bureau d'études : géomètre-dessinateur, chargé d'études", "Levés, plans d'exécution et de récolement, études de prix, appui aux équipes de chantier.", "Formation topographie ou génie civil, maîtrise des outils de dessin.")}
{job("equipe", "Alternance et stages", "Nous accueillons des alternants et des stagiaires sur le terrain comme au bureau d'études.", "Bac pro, BTS, licence ou école : parlez-nous de votre projet.")}
</div></div></section>'''
body += f'''<section class="section bg-navy"><div class="container">{section_head("Le parcours", "Comment ça se passe.", "Quatre étapes simples, une réponse à chaque candidature.", light=True)}{process([
 ("controle", "Candidature", "Envoyez votre CV et quelques lignes sur votre parcours, par le formulaire ou par email. Nous répondons à toutes les candidatures."),
 ("continuite", "Échange téléphonique", "Un premier échange pour comprendre votre expérience, vos attentes et vous présenter le poste."),
 ("ville", "Rencontre au siège", "Un entretien à Toulouse, avec visite de l'atelier et, quand c'est possible, d'un chantier en cours."),
 ("securite", "Intégration", "Accueil sécurité, équipements fournis, binôme avec un collègue expérimenté pendant les premières semaines."),
])}</div></section>'''
body += f'''<section class="section"><div class="container"><div class="contact-grid"><div><p class="eyebrow" data-reveal>Candidature</p><h2 class="h2" style="margin-top:20px" data-split>Envoyez-nous votre candidature.</h2><p class="lead" style="margin-top:24px" data-reveal>Par le formulaire ci-contre ou directement par email, avec votre CV. Candidatures spontanées bienvenues, toute l'année.</p><ul class="contact-list stagger"><li><span class="mono">Email</span><a href="mailto:contact@lagaronnetp.org?subject=Candidature">contact@lagaronnetp.org</a></li><li><span class="mono">Téléphone</span><a href="tel:+33562130780">+33 5 62 13 07 80</a></li><li><span class="mono">Siège</span><address style="font-style:normal">SA LA GARONNE<br>63 chemin de Guilhermy<br>31100 Toulouse</address></li></ul></div>
<form class="form" data-form novalidate data-reveal>
<p class="eyebrow">Formulaire</p>
<div class="form__row"><div class="field"><label for="f-nom">Nom et prénom *</label><input id="f-nom" name="nom" type="text" required autocomplete="name"></div><div class="field"><label for="f-tel">Téléphone</label><input id="f-tel" name="telephone" type="tel" autocomplete="tel"></div></div>
<div class="form__row"><div class="field"><label for="f-email">Email *</label><input id="f-email" name="email" type="email" required autocomplete="email"></div><div class="field"><label for="f-objet">Poste souhaité *</label><select id="f-objet" name="objet" required><option value="Candidature">Candidature</option><option value="Candidature : canalisateur">Canalisateur</option><option value="Candidature : chef de chantier">Chef de chantier</option><option value="Candidature : conducteur d'engins">Conducteur d'engins</option><option value="Candidature : réhabilitation sans tranchée">Réhabilitation sans tranchée</option><option value="Candidature : bureau d'études">Bureau d'études</option><option value="Candidature : alternance / stage">Alternance / stage</option></select></div></div>
<div class="field"><label for="f-msg">Votre parcours *</label><textarea id="f-msg" name="message" required placeholder="Votre expérience, vos formations, vos disponibilités…"></textarea></div>
<input type="text" name="_gotcha" tabindex="-1" autocomplete="off" class="hp" aria-hidden="true">
<div class="field" style="grid-template-columns:auto 1fr;display:grid;gap:12px;align-items:start"><input id="f-rgpd" name="consentement" type="checkbox" required style="width:18px;height:18px;margin-top:3px"><label for="f-rgpd" style="text-transform:none;letter-spacing:0;font-family:var(--font-body);font-size:.85rem;color:var(--navy)">J'accepte que les informations saisies soient utilisées pour traiter ma candidature. Elles ne sont ni cédées ni utilisées à d'autres fins.</label></div>
<div class="form__foot"><button class="btn" type="submit">Envoyer ma candidature {ARROW}</button><p class="form__note">* Champs obligatoires. Pensez à joindre votre CV par email.</p></div>
<p class="form__status" role="status" aria-live="polite"></p>
</form></div></div></section>'''
page("recrutement.html", "Recrutement — rejoindre SA LA GARONNE à Toulouse",
     "SA LA GARONNE recrute canalisateurs, chefs de chantier, conducteurs d'engins et opérateurs de réhabilitation à Toulouse. Entreprise familiale, sécurité, formation, candidature spontanée bienvenue.", body, "chantier-tranchee-centre-ville-1280.jpg",
     crumbs=[("Recrutement", None)])
...
page("contact.html", "Contact — SA LA GARONNE, Toulouse",
     "Contactez SA LA GARONNE : devis, consultation de marché public ou question technique. 63 chemin de Guilhermy, 31100 Toulouse. Tél. 05 62 13 07 80.", body, "chantier-hydrocurage-equipe-1280.jpg",
     crumbs=[("Contact", None)])
...
page("mentions-legales.html", "Mentions légales — SA LA GARONNE", "Mentions légales du site de SA LA GARONNE, société de travaux publics à Toulouse : éditeur, hébergement, données personnelles.", body, crumbs=[("Mentions légales", None)])

# ---------------------------------------------------------------- 404
body = f'''<section class="hero-page" style="min-height:70vh;display:flex;align-items:center">{RINGS}<div class="container"><p class="eyebrow eyebrow--light" data-reveal>Erreur 404</p><h1 class="h1" data-split>Cette page n'existe pas.</h1><p class="lead" data-reveal>Le lien est peut-être ancien ou l'adresse contient une erreur. Nos expertises, nos réalisations et nos coordonnées restent accessibles ci-dessous.</p><div class="hero__actions" data-reveal><a class="btn" href="index.html">Retour à l'accueil {ARROW}</a><a class="btn btn--ghost-light" href="contact.html">Nous contacter</a></div></div></section>'''
page("404.html", "Page introuvable — SA LA GARONNE", "La page demandée n'existe pas. Retrouvez les expertises, réalisations et coordonnées de SA LA GARONNE.", body, md=None)
