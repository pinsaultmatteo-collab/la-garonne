# L'entreprise — SA LA GARONNE, Toulouse depuis 1956
...
**Études de prix et mémoires techniques**Une réponse précise aux consultations : variantes, phasages et méthodes argumentés.

**Levés hebdomadaires des travaux**Un géomètre-dessinateur pour quatre équipes de chantier : les ouvrages réalisés sont levés chaque semaine.

**Plans d'exécution et de récolement**Une réactivité réelle dans la production des plans, pour le chantier comme pour l'exploitant.

**Appui technique aux équipes**Le chargé d'études suit le chantier, anticipe les points durs et sécurise les choix d'exécution.
...
**FNTP** 5118 · AEP zone urbaine**FNTP** 5141 · Tranchées fortes profondeurs**FNTP** 5161 · Grand diamètre**FNTP** 5221 · Réhabilitation réseaux visitablesLabel CanalisateurLabel RSE TPEngagé RSE · AFNORAmiante SS3AIPR · CATEC · SST · H0B0QualibatNF · AFNOR
...
Tendre vers le zéro accidentComité RSE trimestrielPartenariats locauxRéemploi des déblaisChantier bas carbone · biocarburant
...
Direction**Nicolas Pascual — 3e génération**

Effectif**35 salariés · 4 équipes de chantier · atelier · bureau d'études**

Activité**Assainissement 75 % · eau potable 15 % · sans tranchée 10 %**

SIREN**560 800 583**

Code APE**4221Z — Construction de réseaux pour fluides**

Siège**63 chemin de Guilhermy, 31100 Toulouse**
